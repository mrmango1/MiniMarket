...
public class Login extends javax.swing.JFrame {
    ...
    private void pwdUserFocusGained(java.awt.event.FocusEvent evt) {                                    
        pwdUser.setText("");
    }

    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {                                      
        User user = new User();
        Integer login = user.login(txtUser.getText(),pwdUser.getText(),this);
        if(login == null){
            JOptionPane.showMessageDialog(null, "Usuario o contraseña incorrecto");
        }
    }

    private void viewPwdActionPerformed(java.awt.event.ActionEvent evt) {                                        
