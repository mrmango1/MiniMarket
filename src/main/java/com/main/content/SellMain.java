...
public class SellMain extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblBill.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Categoria", "Descripcion", "PvP", "Dsc%", "Cant", "Subtotal"
            }
        ) {
        ...
        if (tblBill.getColumnModel().getColumnCount() > 0) {
            ...
            tblBill.getColumnModel().getColumn(2).setPreferredWidth(120);
            tblBill.getColumnModel().getColumn(2).setMaxWidth(160);
            ...
            tblBill.getColumnModel().getColumn(5).setMaxWidth(60);
            tblBill.getColumnModel().getColumn(6).setPreferredWidth(40);
            tblBill.getColumnModel().getColumn(6).setMaxWidth(50);
    ...
    public void addToCar(){
        ...
        sView.addToCar(tblBill, idProduct, quantity);
        txtTotalPrice.setText(String.valueOf(sView.getTotalPrice()));
    }
