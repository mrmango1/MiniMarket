...
public class ProductsMain extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Prov", "Nombre", "Stock", "Precio", "PvP", "Desc %", "Descripction", "Categoria", "Status"
            }
        ) {
        ...
        if (tblProducts.getColumnModel().getColumnCount() > 0) {
            ...
            tblProducts.getColumnModel().getColumn(1).setMinWidth(70);
            ...
            tblProducts.getColumnModel().getColumn(9).setMaxWidth(60);
        }
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        Functions.tableSorter(tblProducts, query);
